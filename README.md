...
```
Here you can add new checks from this package (like [`DebugIsNotUsed.check`](https://packages.gren-lang.org/package/lue-bird/gren-extra-checks/version/2.0.2/module/DebugIsNotUsed#check)), local code or `gren package install` to the `checks` list,
